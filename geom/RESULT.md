...
$\vec{a} = -3 \vec{b} \Rightarrow \left| \vec{a} \right| = 3 * \left| \vec{b} \right|$

## Координаты вектора

Любой вектор можно разложить по 2 любым неколлинеарным (между собой) векторам, и это разложение однозначно:

$$\vec{p} \quad \vec{a} \nparallel \vec{b}$$
$$\vec{p} = x * \vec{a} + y * \vec{b}$$

$\vec{a}$ и $\vec{b}$ - базисные векторы

$\vec{p}\ (\ x;\ y\ )$ в системе координат, заданных базисными векторами $\vec{a}$ и $\vec{b}$

У равных векторов соответственные координаты равны

### Декартова система координат (рис. 7)

<img width="536" height="398" alt="Снимок экрана 2025-09-04 194008" src="https://github.com/user-attachments/assets/d1a9649a-2c82-45cc-839b-439b0a98f064" />

*Рис. 7*

Здесь $\vec{i}$ и $\vec{j}$ - базисные, они единичные.
...
Координаты вектора получаем за счет вычитания соответственных координат **начала** из **конца** 
...
### ... равного разности двух векторов
...
### ... равного вектору, умноженному на число
...
## Простейшие задачи про векторы + координаты

1) Длина вектора по его координатам (рис. 8)

<img width="424" height="205" alt="Снимок экрана 2025-09-04 224023" src="https://github.com/user-attachments/assets/33885160-3d59-43a1-a40d-9bd7c21e88c4" />

*Рис. 8*

$$
\left| \vec{p} \right| = \sqrt{x^2+y^2}
$$

2) Длина вектора по координатам концов вектора
...
\vec{AB}\ (\ x_2-x_1;\ y_2-y_1\ )  
$$
$$ AB = \left| \vec{AB} \right| = \sqrt{\ {(x_2-x_1)}^2 + {(y_2-y_1)}^2\ } $$

3) Нахождение координат середины отрезка

<img width="354" height="298" alt="Снимок экрана 2025-09-04 232000" src="https://github.com/user-attachments/assets/176a9018-9d8d-49a3-af95-3a0bc576aa57" />
